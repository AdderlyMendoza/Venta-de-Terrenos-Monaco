...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('estado', models.CharField(choices=[('VENDIDO', 'Vendido'), ('CUOTAS', 'Cuotas'), ('DISPONIBLE', 'Disponible'), ('SEPARADO', 'Separado')], default='DISPONIBLE', max_length=20, verbose_name='Estado')),
                ('nombre', models.CharField(max_length=50)),
                ...
                ('fecha_creacion', models.DateTimeField(auto_now_add=True)),
                ('fecha_modificado', models.DateTimeField(auto_now_add=True)),
                ('id_personalizado', models.CharField(blank=True, max_length=100, null=True, unique=True)),
                ('manzana', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='proyectos.manzana')),
