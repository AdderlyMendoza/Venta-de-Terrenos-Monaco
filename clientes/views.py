...
def listar_ventas(request):
    ...
    web = Web.objects.all()
    # return render(request, 'clientes/lotes/lista_ventas.html', {'proyectos': proyectos, 'proyecto_seleccionado': proyecto_seleccionado, 'subproyectos': subproyectos})
    return render(request, 'clientes/lotes/lista_ventas.html', {'proyectos': proyectos, 'proyecto_seleccionado': proyecto_seleccionado, 'subproyectos': web})
